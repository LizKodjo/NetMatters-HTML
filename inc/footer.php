...
<footer>
                        ...
                        <div class="container">
                            ...
                            <div class="footer-sections">
                                <div class="container footer-logo">
                                    <img class="light-logo" src="img/asset48.png" alt="Netmatters logo">
                                    <h4>Follow us on:</h4>
                                    <!-- Social Media Logos -->
                                    <div class="social-logos">
                                        <div class="container">
                                            <a href="#" class="fa fa-facebook fb-btn"></a>
                                            <a href="#" class="fa fa-linkedin ln-btn"></a>
                                            <a href="#" class="fa-brands fa-x-twitter tw-btn"></a>
                                            <a href="#" class="fa fa-instagram in-btn"></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="row colsforfooter">
            ...
            <div class="copyright">
                <div class="container">
                    <div class=" copyinfo">&copy; Copyright Netmatters <?php echo date("Y");?>. All rights reserved. - <a href="#">
                            Sitemap</a>
                    </div>
                </div>
            </div>
    ...
    <script src="js/sliderSections.js"></script>

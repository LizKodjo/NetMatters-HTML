    ...
    <div class="container">
        ...
        <div class="container largeSidebar">
            <div id="myLargeSidenav" class="large-nav">
                ...
                <div class="submenu"></div>
                <ul class="mob-submenu">
                    <li><a href="#"><i class="fa-solid fa-angles-right menu-arrows"></i> Train for a career in tech</a>
                    </li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-3 col-sm-6 col-md-7 col-lg-8">
                                    <div class="searchMenu">
                                        <a href="#" class="btn topcontactbtn itbtn hidden-xs hidden-sm header-btn"><span
                                                class="fa-solid fa-computer-mouse"></span>Support
                                        </a>
                                        <a href="contact-us.php"
                                            class="topcontactbtn contactbtn btn btn-default hidden-xs hidden-sm header-btn"><span
                                                class="fa-regular fa-paper-plane contactplane"></span>Contact
                                        </a>
                                        <!-- <span class="material-symbols-outlined smallsearchphone">phone_in_talk</span> -->
                                        <div class="hidden-xs searchInput pull-left search-form-wrapper--tablet">
                                            <form class="searchbar">
                                                <label for="search-tablet search-input" class="hidden">Search:</label>
                                                <input type="text" placeholder="Search..." name="q" id="search-tablet"
                                                    class="form-control search-bar">
                                                <button type="submit" id="search-submit"><i
                                                        class="fa fa-search searchbtn"></i></button>
                                            </form>
                                        </div>
                            ...
                            <div class="hidden-sm hidden-md hidden-lg search-form-wrapper--mobile">
                                <form action="" class="search-form">
                                    ...
                                    <input type="text" class="form-control search-bar" id="search-input"
                                        placeholder="Search...">
                                    <button type="submit" id="seach-submit" class="fa fa-search searchbtn"></button>
                                </form>
                            </div>
                            ...
                            <div class="container menu-breakdown">
                                                ...
                                                <div class="firstrow">
                                                    ...
                                                    <div class="firstcolumn">
                                                        ...
                                                        <a href="#" class="topnav-sublink">
                                                            ...
                                                            <span class="link-text">Sharepoint
                                                                Development</span>
                                                        </a>
                                                        <a href="#" class="topnav-sublink">
                                                            <i class="fa-solid fa-laptop"></i>
                                                            <span class="link-text">Internet of Things
                                                                (IoT)
                                                                Software</span>
                                                        </a>
                                                        <a href="#" class="topnav-sublink">
                                ...
                                <div class="itsupport">
                                    ...
                                    <div class="itsupport-content">
                                        <div class="container dropdown-heading">
                                            <a class="content-heading" href="#">Our IT Support
                                                Services</a>
                                        </div>
                                        <div class="container">
                                            <div class="firstrow">
                                                <div class="firstcolumn">
                                                    <a href="#">
                                                        ...
                                                        <span class="link-text">Managed IT
                                                            Support</span>
                                                    </a>
                                                    <a href="#">
                                                ...
                                                <div class="firstcolumn">
                                                    <a href="#">
                                                        ...
                                                        <span class="link-text">Business IT
                                                            Support</span>
                                                    </a>
                                                    <a href="#">
                                                        <i class="fa-solid fa-cloud"></i>
                                                        <span class="link-text">Cloud Service
                                                            Provider</span>
                                                    </a>
                                                </div>
                                                <div class="firstcolumn">
                                                    <a href="#">
                                                        <i class="fa-solid fa-laptop"></i>
                                                        <span class="link-text">Office 365 for
                                                            Business</span>
                                                    </a>
                                                    <a href="#">
                                ...
                                <div class="telecomsservices">
                                    ...
                                    <div class="telecoms-content">
                                        <div class="container dropdown-heading">
                                            <a class="content-heading" href="#">Our Telecoms
                                                Services</a>
                                        </div>
                                        <div class="container">
                                            <div class="firstrow">
                                ...
                                <div class="webdesign">
                                    ...
                                    <div class="webdesign-content">
                                        <div class="container dropdown-heading">
                                            <a class="content-heading" href="#">Our Web Design
                                                Services</a>
                                        </div>
                                        <div class="container">
                                            <div class="firstrow">
                                                ...
                                                <div class="firstcolumn">
                                                    <a href="#"><i
                                                            ...
                                                            eCommerce
                                                            Stores</span></a>
                                                    <a href="#"><i class="fa-solid fa-mobile-screen-button"></i><span
                                                            class="link-text">
                                                            Mobile
                                                            App
                                                            Development</span></a>
                                ...
                                <div class="cyber">
                                    ...
                                    <div class="cyber-content">
                                        <div class="container dropdown-heading">
                                            <a class="content-heading" href="#">Our Cyber Security
                                                Services</a>
                                        </div>
                                        <div class="container">
                                            <div class="firstrow">
